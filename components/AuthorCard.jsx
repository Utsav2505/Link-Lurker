...
const AuthorCard = ({ img_link, name, links }) => {
  const router = useRouter();
  return (
    <div className="card-container">
      <img className="card-img" src={links.image} alt="developer" />
      <div className="card-name open-sans-500">{name}</div>
      <div className="links-row">
        <div onClick={() => router.push(links.git)}>
          <svg
        ...
        <div onClick={() => router.push(links.linkedin)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            className="link-icon"
        ...
        <div onClick={() => router.push(links.coffee)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
            className="link-icon"
